...
/* 
    También on conocidos como operadore de corto circuito ( short-circuit operators).

    && : La evaluación se detiene tan pronto como se encuentra un operador falso.
         Ya no e evalua el segundo operando y se retorna la expresión de op1.

         op1 && op2 si op1 es verdadero, se realiza la expresion de op2.
        
    || : Si op1 es verdadero, se realiza la expresion de op1, no se realiza la expresión de op2.

*/

const aa = true, bb = true, cc= true;
